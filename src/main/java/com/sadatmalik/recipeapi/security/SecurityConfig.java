package com.sadatmalik.recipeapi.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Override
    // This security configuration takes care of opening the GET (and one POST) endpoints to the world,
    // while restricting all others to only authenticated users.
    ...
    @Override
    // Registers a CustomUserDetailsService and BCryptPasswordEncoder with the AuthenticationManager
